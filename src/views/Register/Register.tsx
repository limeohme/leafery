...
export default function Register () {
  ...
  return (
    <Box sx={{ m: '10vw', display: 'flex', flexDirection: 'column', 
      ...
      <TextField sx={textInputStyles} placeholder={'email'} onChange={(e) => setFormData({ ...formData, email: e.target.value })}/>
      ...
      <Button 
        sx={{ color: lightTheme.txcolour, bgcolor: lightTheme.accent, width: 'fit-content', alignSelf: 'center' }}
